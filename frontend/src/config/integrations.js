...
export const PLATFORMS = [
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://mystore.myshopify.com/admin/api/2024-01",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.clover.com/v3",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.lightspeedapp.com",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "endpointPath",
				label: "Transactions Path",
				placeholder: "/orders/v2/ordersBulk",
				type: "text",
				required: false,
				defaultValue: "/orders/v2/ordersBulk",
			},
		],
		fieldMap: {
			net_sales: "revenue",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.busy.in/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.vyaparapp.in/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://developers.petpooja.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.posist.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.khatabook.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		authFields: [
			...
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.mybillbook.in/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		logo: null,
		description:
			"Connect Gofrugal to import billing transactions, customer counts, and order volume.",
		categories: ["grocery", "retail", "pharmacy", "general"],
		...
		authFields: [
			{
				key: "apiToken",
				label: "API Token",
				placeholder: "Your Gofrugal token",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.your-gofrugal-domain.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		logo: null,
		description:
			"Sync invoices and order transactions from NammaBilling into Yukti daily logs.",
		categories: ["grocery", "retail", "bakery", "general"],
		website: "https://nammabilling.com",
		authType: "api_key",
		authFields: [
			{
				key: "apiKey",
				label: "API Key",
				placeholder: "Your NammaBilling API key",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.nammabilling.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		logo: null,
		description:
			"Bring pharmacy/retail billing, stock and invoice data from Marg ERP.",
		categories: ["pharmacy", "retail", "grocery", "general"],
		...
		authFields: [
			{
				key: "apiToken",
				label: "API Token",
				placeholder: "Your Marg ERP token",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.margerp.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
		...
		fieldMap: {
			...
			stock_qty: "inventoryCount",
		},
	},
	{
		id: "retailpos_unipro",
		name: "RetailPOS (Unipro)",
		logo: null,
		description:
			"Import counter transactions and order summaries from RetailPOS by Unipro.",
		categories: ["retail", "grocery", "general"],
		website: "https://www.uniproindia.com",
		authType: "api_key",
		authFields: [
			{
				key: "apiKey",
				label: "API Key",
				placeholder: "Your RetailPOS API key",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.retailpos.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		logo: null,
		description:
			"Connect ECBill to pull invoice transactions and daily billing snapshots.",
		categories: ["retail", "grocery", "pharmacy", "general"],
		website: "https://ecbill.in",
		authType: "api_key",
		authFields: [
			{
				key: "apiToken",
				label: "API Token",
				placeholder: "Your ECBill token",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.ecbill.in/v1",
				type: "text",
			},
			{
				key: "endpointPath",
	...
	},
	{
		...
		logo: null,
		description:
			"Pull Zubizi billing and order events into Yukti for automated analysis.",
		categories: ["retail", "restaurant", "grocery", "general"],
		website: "https://zubizi.com",
		authType: "api_key",
		authFields: [
			{
				key: "accessToken",
				label: "Access Token",
				placeholder: "Your Zubizi access token",
				type: "password",
			},
			{
				key: "apiBaseUrl",
				label: "API Base URL",
				placeholder: "https://api.zubizi.com/v1",
				type: "text",
			},
			{
				key: "endpointPath",
