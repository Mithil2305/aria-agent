  ...
  const askQuestion = async (question) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          text: ans.answer || "I couldn't find a clear answer. Try asking with more specific terms.",
    ...
    <div className="card flex flex-col" style={{ height: "480px" }}>
      ...
      <div className="px-5 py-4 border-b border-surface-200 flex items-center gap-2 shrink-0">
        ...
        <div>
          ...
          <p className="text-[10px] text-surface-400">Ask anything about your business</p>
        </div>
        {!analysisReady && (
            ...
            >
              ...
              {msg.highlight && (
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-indigo-50 border border-indigo-200">
                  ...
                  <span className="text-sm font-bold text-indigo-700">{msg.highlight}</span>
                </div>
              )}
              ...
              {msg.action && (
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-amber-50 border border-amber-200">
                  ...
                  <p className="text-xs text-amber-800 font-medium leading-relaxed">{msg.action}</p>
                </div>
              )}
      ...
      {/* Input */}
      <form onSubmit={handleSubmit} className="px-4 py-3 border-t border-surface-200 shrink-0">
